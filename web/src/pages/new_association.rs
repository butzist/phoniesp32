            ...
            b::Container {
                ...
                b::Notification {
                    ...
                    if let Some(fob) = last_fob() {
                        span { "Create a playlist to associate with last scanned FOB: " b { "{fob}" } }
                    } else {
                            ...
                            b::Card {
                                ...
                                b::CardContent {
                                    if playlist().is_empty() {
                                        div {
                                            class: "box has-text-grey has-border",
                                            ...
                                            tbody {
                                                 for (index, file_name) in playlist().iter().enumerate() {
                                                     ...
                                                     if let Some(drop_idx) = drop_target_index() {
                                                         if drop_idx == index {
                                                             tr {
                                                                 style: "height: 1px; background-color: #3273dc;",
                                                                 td {
                                                                     colspan: "5",
                                             ...
                                             ondrop: move |evt| {
                                                 ...
                                                 if let Some(drop_idx) = drop_target_index() {
                                                     ...
                                                     tr {
                                                         ...
                                                         ondrop: move |evt| {
                                                             ...
                                                             if let Some(dragged_idx) = dragged_index() {
                                                                 if dragged_idx != index {
                                                                     ...
                                                                     let insert_index = if dragged_idx < index {
                                                                         index - 1
                                                                     } else {
                                                                         index
                                                                     };
                                                         ...
                                                         td {
                                                             div {
                                                                 style: "cursor: grab; margin-right: 8px; display: inline-block;",
                                    ...
                                    b::Button {
                                        ...
                                        onclick: move |_| {
                                            ...
                                            let mut save_status_type_signal = save_status_type;
                                            spawn(async move {
                                                if let Err(e) = services::fob::associate_fob(&fob, &current_playlist).await {
                                                    save_status_signal.set(Some(format!("Failed associating playlist with FOB: {}", e)));
                                                    save_status_type_signal.set(b::BulmaColor::Warning);
                                                } else {
                                                    save_status_signal.set(Some(format!("Successfully associated {} files with FOB", current_playlist.len())));
                                                    save_status_type_signal.set(b::BulmaColor::Success);
                                                }
                                            });
                                        },
                                        "Save Playlist"
